...
export CAPX_MODEL="${CAPX_MODEL:-google/gemini-3.1-pro-preview}"
export CAPX_PROXY_HOST="${CAPX_PROXY_HOST:-127.0.0.1}"
export CAPX_PROXY_PORT="${CAPX_PROXY_PORT:-8110}"
export CAPX_SERVER_URL="${CAPX_SERVER_URL:-http://${CAPX_PROXY_HOST}:${CAPX_PROXY_PORT}/chat/completions}"
